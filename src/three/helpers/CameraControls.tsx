...
type CameraControls = CameraControlsDefault;

const CameraControls = forwardRef<CameraControls, ICameraControlsProps>(
	(props, ref) => {
...
CameraControls.displayName = "Camera controls";
